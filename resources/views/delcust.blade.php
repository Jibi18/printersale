...
<h4><center><b>DELETE CUSTOMER</h4>
<form action="/custdelprocess/{{$customers->id}}" method="post">
@csrf
    <table class="table table-borderless">
        <tr>
            <td>Name</td>
            <td><input value="{{ $customers->Name }}" type="text" name="pname" class="form-control"></td>
        </tr>
        <tr>
            <td>Address</td>
            <td><input value="{{ $customers->Add }}" type="text" name="ppri" class="form-control"></td>
        </tr>
        <tr>
            <td>Email</td>
            <td><input value="{{ $customers->Email }}" type="text" name="pdes" class="form-control"></td>
        </tr>
        <tr>
            <td>Phone</td>
            <td><input value="{{ $customers->Phno }}" type="text" name="pgal" class="form-control"></td>
        </tr>
        <tr>
            <td></td>
